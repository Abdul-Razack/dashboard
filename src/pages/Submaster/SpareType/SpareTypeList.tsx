...
import { useSpareTypeIndex } from '@/services/submaster/sparetype/services';

import ModalForm from '@/pages/Submaster/SpareType/ModalForm';

// import SpareTypeCreateModal from './SpareTypeCreateModal';
// import SpareTypeUpdateModal from './SpareTypeUpdateModal';
...
const SpareTypeList = () => {
  ...
  const data = spareTypeList?.items ?? [];
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>Spare Type List</Heading>
