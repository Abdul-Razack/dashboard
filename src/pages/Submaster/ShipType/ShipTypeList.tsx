...
import { useShipTypesIndex } from '@/services/submaster/ship-types/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/ShipType/ModalForm';

// import CreateModal from './ShipTypeCreateModal';
// import UpdateModal from './ShipTypeUpdateModal';
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>Ship Type List</Heading>
