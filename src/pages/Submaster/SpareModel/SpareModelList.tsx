...
import { useSpareModelIndex } from '@/services/submaster/sparemodel/services';

import ModalForm from '@/pages/Submaster/SpareModel/ModalForm';

// import SpareModelCreateModal from './SpareModelCreateModal';
// import SpareModelUpdateModal from './SpareModelUpdateModal';

const SpareModelList = () => {
  ...
  const data = spareModelList?.items ?? [];
      ...
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          <Heading as="h4" size={'md'}>
            Customer Submaster - Spare Model
          </Heading>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>Spare Model List</Heading>
            <Box flex="1" maxW="300px">
              <TableSearchBox
                value={searchTerm}
                onChange={setSearchTerm}
                width="100%"
                placeholder={'Search Spare Model'}
              />
            </Box>
          </HStack>
          <DataTable
