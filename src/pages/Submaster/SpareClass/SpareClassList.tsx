...
import { useSpareClassIndex } from '@/services/submaster/spareclass/services';

import ModalForm from '@/pages/Submaster/SpareClass/ModalForm';

// import SpareClassCreateModal from './SpareClassCreateModal';
// import SpareClassUpdateModal from './SpareClassUpdateModal';

const SpareClassList = () => {
  ...
  const data = spareClassList?.items ?? [];
      ...
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          <Heading as="h4" size={'md'}>
            Customer Submaster - Spare Class
          </Heading>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>Spare Class List</Heading>
            <Box flex="1" maxW="300px">
              <TableSearchBox
                value={searchTerm}
                onChange={setSearchTerm}
                width="100%"
                placeholder={'Search Spare Class'}
              />
            </Box>
          </HStack>
          <DataTable
