...
import { useHscCodeIndex } from '@/services/submaster/hsc-code/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/HscCode/ModalForm';
// import CreateModal from './HSCCreateModal';
// import UpdateModal from './HSCUpdateModal';
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>HSC List</Heading>
            <Box flex="1" maxW="300px">
              <TableSearchBox
                value={searchTerm}
                onChange={setSearchTerm}
                width="100%"
                placeholder={'Search HSC'}
              />
            </Box>
          </HStack>
          <DataTable
