...
import { ShipACDataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/ShipAccounts/ModalForm';

// import CreateModal from './ShipAccountCreateModal';
// import UpdateModal from './ShipAccountUpdateModal';

const ShipAccountsList = () => {
  ...
  const columnHelper = createColumnHelper<ShipACDataColumn>();
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>ShipAccounts List</Heading>
            <Box flex="1" maxW="300px">
              <TableSearchBox
                value={searchTerm}
                onChange={setSearchTerm}
                width="100%"
                placeholder={'Search ShipAccounts'}
              />
            </Box>
          </HStack>
          <DataTable
...
export default ShipAccountsList;
