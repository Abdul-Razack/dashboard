...
import { useContactTypeIndex } from '@/services/submaster/contacttype/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/ContactType/ModalForm';

// import ContactTypeCreateModal from './ContactTypeCreateModal';
// import ContactTypeUpdateModal from './ContactTypeUpdateModal';
      ...
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          <Heading as="h4" size={'md'}>
            Customer Submaster - Contact Type
          </Heading>
