...
import { useModeOfReceiptIndex } from '@/services/submaster/mode-of-receipt/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/ModeOfReceipt/ModalForm';


const ModeOfReceiptList = () => {
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>Mode Of Receipt List</Heading>
...
export default ModeOfReceiptList;
