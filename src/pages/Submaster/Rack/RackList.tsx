...
import { DataColumn } from '@/services/submaster/rack/schema';

import ModalForm from '@/pages/Submaster/Rack/ModalForm';

// import CreateModal from './RackCreateModal';
// import UpdateModal from './RackUpdateModal';
...
const RackList = () => {
  ...
  columnHelper.accessor('name', {
    ...
    columnHelper.accessor('is_quarantine', {
