...
import ModalForm from '@/pages/Submaster/BusinessType/ModalForm';
import { useBusinessTypeIndex } from '@/services/submaster/businesstype/services';
...
const BusinessTypeList = () => {
  ...
  const handleSortChange = (columnId: string, direction: 'asc' | 'desc') => {
    ...
    // You might want to refetch data here for server-side sorting
  };
    ...
    <SlideIn>
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          <Heading as="h4" size={'md'}>
            Customer Submaster - Business Type
          </Heading>
      ...
      />
        ...
        <Box borderRadius={4}>
          ...
          >
            <Heading as="h4" size={'md'} whiteSpace="nowrap" mr={4}>
              Business Type List
            </Heading>
