...
import { useShipModesIndex } from '@/services/submaster/ship-modes/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/ShipMode/ModalForm';

// import CreateModal from './ShipModeCreateModal';
// import UpdateModal from './ShipModeUpdateModal';
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>ShipModes List</Heading>
            <Box flex="1" maxW="300px">
              <TableSearchBox
                value={searchTerm}
                onChange={setSearchTerm}
                width="100%"
                placeholder={'Search ShipModes'}
              />
            </Box>
          </HStack>
          <DataTable
