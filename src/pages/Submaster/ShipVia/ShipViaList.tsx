...
import { useShipViaIndex } from '@/services/submaster/ship-via/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/ShipVia/ModalForm';

// import CreateModal from './ShipViaCreateModal';
// import UpdateModal from './ShipViaUpdateModal';
      ...
      <Stack pl={2} spacing={4}>
        ...
        <Box borderRadius={4}>
          <HStack
            ...
            borderTopRadius={4}
          >
            <Heading as="h4" size={'md'}>ShipVia List</Heading>
            <Box flex="1" maxW="300px">
              <TableSearchBox
                value={searchTerm}
                onChange={setSearchTerm}
                width="100%"
                placeholder={'Search ShipVia'}
              />
            </Box>
          </HStack>
          <DataTable
