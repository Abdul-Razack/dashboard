...
import { usePaymentModeIndex } from '@/services/submaster/paymentmode/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/PaymentMode/ModalForm';

// import PaymentModeCreateModal from './PaymentModeCreateModal';
...
const PaymentModeList = () => {
  ...
  const data = paymentModeList?.items ?? [];
      ...
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          <Heading as="h4" size={'md'}>
            Customer Submaster - Payment Mode
          </Heading>
