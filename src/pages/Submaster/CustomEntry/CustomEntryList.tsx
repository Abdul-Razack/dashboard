...
import { useCustomEntryIndex } from '@/services/submaster/customentry/services';
import { DataColumn } from '@/services/submaster/schema';

import ModalForm from '@/pages/Submaster/CustomEntry/ModalForm';

// import CreateModal from './CustomEntryCreateModal';
// import UpdateModal from './CustomEntryUpdateModal';

const CustomEntryList = () => {
          ...
          >
            ...
            <Box flex="1" maxW="300px">
              <TableSearchBox
                ...
                width="100%"
                placeholder={'Search Custom Entry'}
              />
            </Box>
          </HStack>
          <DataTable
