          ...
          <Stack spacing={0}>
            ...
            >
              ...
              <BreadcrumbItem isCurrentPage color={'gray.500'}>
                <BreadcrumbLink>Direct Purchase Order Create</BreadcrumbLink>
              </BreadcrumbItem>
            </Breadcrumb>
            ...
            <Stack spacing={2}>
              ...
              >
                <FieldSelect
                  ...
                  // isDisabled={shipToCustomer === 0}
                  //   className={shipToCustomer === 0 ? 'disabled-input': ''}
                />
                            ...
                            <Tr key={item.id}>
                              ...
                              <Td>
                                ...
                                >
                                  ...
                                  />
                                  <FieldSelect
                                    key={`part_number_${item.id}_${partNumKey}`}
                              ...
                              <Td>
                                <FieldSelect
                                  key={`condition_id_${resetKey}`}
                                  id={`condition_id_${item.id}`}
                                ...
                                <Text>
                                  ...
                                  <Text as="span" ml={1}>
                                    {Number(
                                      ...
                                      Number(
                                        fields[`quantity_${item.id}`]?.value ??
                                          0
                                      )}
                                  </Text>
                                </Text>
