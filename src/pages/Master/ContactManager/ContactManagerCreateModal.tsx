...
type ContactManagerCreateModalProps = {
  isOpen: boolean;
  onClose: () => void;
  customer_id?: string;
...
const ContactManagerCreateModal = ({
  isOpen,
  onClose,
  customer_id,
  onModalClosed,
}: ContactManagerCreateModalProps) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={() => handleClose(false, null)} size={'xl'} closeOnOverlayClick={false} closeOnEsc={false}>
      <ModalOverlay />
      <ModalContent>
        <Formiz autoForm connect={form}>
          <ModalHeader>Create Contact Manager</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
              ...
              <Stack spacing={2}>
                <Stack spacing={8} direction={{ base: 'column', md: 'row' }}>
                  <FieldSelect
                    ...
                    className={!!customerId ? 'disabled-input' : ''}
                  />
...
export default ContactManagerCreateModal;
