...
import { useCreateTrader } from '@/services/master/tradersref/services';
...
const TraderReferenceCreate = () => {
  ...
  const createTraderReference = useCreateTrader({
    onSuccess: ({ id, message }) => {
      toastSuccess({
        title: 'Trader reference created - ' + id,
        description: message,
      });
  ...
  const form = useForm({
    onValidSubmit: (values) => {
      ...
      createTraderReference.mutate(payload);
    },
  });
          ...
          <Stack spacing={0}>
            ...
            >
              ...
              <BreadcrumbItem isCurrentPage color={'gray.500'}>
                <BreadcrumbLink>Add New Trader Reference</BreadcrumbLink>
              </BreadcrumbItem>
            </Breadcrumb>
            ...
            <LoadingOverlay isLoading={!allApiDataLoaded}>
              <Stack spacing={2}>
                ...
                <Button
                  ...
                  mx={'auto'}
                  mt={4}
                  isLoading={createTraderReference.isLoading}
                  disabled={createTraderReference.isLoading}
                >
                  Add New Trader Reference
                </Button>
              </Stack>
...
export default TraderReferenceCreate;
