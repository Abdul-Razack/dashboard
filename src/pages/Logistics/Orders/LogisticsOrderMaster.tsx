...
import { LogisticsOrderSearch } from '@/components/SearchBars/Logistics/Order';
...
export const LogisticsOrderMaster = () => {
      ...
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          ...
          <ResponsiveIconButton
            ...
            icon={<LuPlus />}
            size={{ base: 'sm', md: 'md' }}
            onClick={() => navigate('/logistics/order/create')}
          >
            Add Logistic Order
          </ResponsiveIconButton>
        </HStack>
        <LogisticsOrderSearch
...
export default LogisticsOrderMaster;
