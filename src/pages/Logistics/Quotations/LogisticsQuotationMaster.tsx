...
import { QuotionSearch } from '@/components/SearchBars/Logistics/Quotation';
...
const LogisticsQuotationMaster = () => {
      ...
      <Stack pl={2} spacing={4}>
        <HStack justify={'space-between'}>
          ...
          <ResponsiveIconButton
            ...
            icon={<LuPlus />}
            size={{ base: 'sm', md: 'md' }}
            onClick={() => navigate('/logistics/quotation/create')}
          >
            Add Quotation
          </ResponsiveIconButton>
        </HStack>
...
export default LogisticsQuotationMaster;
