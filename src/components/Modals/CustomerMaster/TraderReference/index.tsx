...
export function TraderReferenceModal({
  ...
  const addDetails = useCreateTrader({
    onSuccess: ({id}) => {
      toastSuccess({
        title: 'Trader Reference Added successfully',
        description:
          'Trader Reference details added successfully under the customer',
      });
      onClose(true, id);
    },
    onError: ({response}) => {
  ...
  const updateDetails = useUpdateTrader({
    onSuccess: ({id}) => {
      toastSuccess({
        title: 'Trader Reference updated successfully',
        description: 'Trader Reference updated successfully under the customer',
      });
      onClose(true, id);
    },
    onError: ({response}) => {
  ...
  useEffect(() => {
    if (existValues !== null) {
      const init = {
        vendor_name: existValues?.vendor_name ?? '',
