...
import { downloadPDF, triggerPrint } from '@/helpers/commonHelper';
...
export const InvoicePreview = ({ isOpen, onClose, data }: ModalPopupProps) => {
  const minH = 1122;
                      ...
                      <Table variant="unstyled" size={'sm'}>
                        ...
                        <Tbody>
                          <Tr>
                            ...
                            >
                              {data?.inv_entry_no ? data?.inv_entry_no : ' - '}
                            </Td>
                            <Td
                              sx={{
                                fontSize: '13px',
                            ...
                            >
                              {data?.payment_done_date
                                ? format(
                                    new Date(data.payment_done_date),
                                    'dd-MM-yyyy'
                                  )
                                : ' - '}
                            </Td>
                            ...
                            >
                              {data?.tax_invoice_date
                                ? format(
                                    new Date(data?.tax_invoice_date),
                                    'dd-MM-yyyy'
                                  )
                                : ' - '}
                            </Td>
